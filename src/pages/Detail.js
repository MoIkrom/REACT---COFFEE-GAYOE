  ...
  return (
    <>
      ...
      <div className="cont_1 container">
        <strong>
          <Link className="text-black text-decoration-none" to={"/product"}>
            Product
          </Link>
        ...
        <div className="container d-flex flex-column flex-md-row justify-content-center align-items-center">
          <div className="cont_product container d-flex flex-column justify-content-center align-items-center text-center gap-3 mt-5 mt-md-0 col-md-4 col-lg-6">
            <div className="cont_img d-flex justify-content-center align-items-center ">
              <img className="image" src={`${Host}/${product.image}`} alt="/" />
            </div>
          ...
          <div className="cont_card col-md-8 col-lg-6 container delivery-time mb-5 ps-md-5 ps-lg-0">
            <Card className=" cardss container font_card p-3 p-lg-5">
              <p className="text-center ftz">
                Delivery only <strong> on Monday to Friday</strong> at{" "}
                <strong>1 - 7 pm </strong>
              </p>
              <div className="mb-5 mt-md-5">
                <h6 className="title_desc m-0 text-decoration-underline ">
                  Description Product :{" "}
                </h6>
                <p className="desc my-1 text-decoration-none ">
                  {product.description}
                </p>
              </div>
              ...
              <div className="Cont_choose mb-5 px-lg-5">
                ...
                <div className="container size">
                  ...
                  <div
                    className={
                      size === "Extra Large" ? "cont-sizes" : "cont-size"
                    }
                    onClick={() => {
                      setSize("Extra Large");
                    }}
              ...
              <div className="container methode-dev mb-4 px-lg-5">
                <h1 className="text-dev mb-3 text-lg-center">
                ...
                <div className="cont_delivery p-0 container d-flex justify-content-between justify-content-lg-evenly">
                  <button
                    className={
                      value === "1"
                        ? "btn btn-outline-secondary btn-dels"
                        : "btn btn-outline-secondary btn-del"
                    }
                    onClick={() => {
                      setValue("1");
                    }}
      ...
      >
        ...
        <Modal.Body>
          are you sure you want <strong style={{ color: "red" }}>Delete</strong>{" "}
          this Product ?
        </Modal.Body>
        <Modal.Footer>
          <Button
