    ...
    <>
      ...
      <section className={`container ${styles["sect-1"]}`}>
        <p className="container">
          Favorite & Promo <strong className={styles["strong"]}> &gt; Add new promo</strong>
        </p>
        <div className={`container ${styles["main"]}`}>
          <div className={`container ${styles[""]}`}>
            ...
            <div className={styles["form-group"]}>
              ...
              <input className={`form-control ${styles["hour"]}`} placeholder="Input discount"></input>
            </div>
              ...
              <div className={`container ${styles["cont-email"]}`}>
                <div className="container">
                  <div className={styles["placeholder"]}>
                    ...
                    <input className={styles["input"]} type="text" placeholder="Type promo name min. 50 characters" />
                    <hr className={styles["my-1"]} />
                  </div>
                  <div className={styles["placeholder"]}>
                    <p className={styles["title-name"]}> Normal Price :</p>
                    <input className={styles["input"]} type="text" placeholder="Type the normal price" />
                    <hr className={styles["my-1"]} />
                  </div>
                  <div className={styles["placeholder"]}>
