...
export const getFixProducts = (category = "", search = "", sort = "name", order = "asc", page = 1) => {
  const URL = `${BaseUrl}${Prefix}product?category=${category}&sort=${sort}&order=${order}&page=${page}&limit=4`;
  return axios.get(URL);
};
